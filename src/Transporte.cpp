...
Transporte::Transporte(const std::string nome, char tipo, int capacidade, int velocidade, int distancia_entre_descansos, int tempo_de_descanso, int tempo_de_descanso_atual, Cidade *local_atual) {
    this->nome = nome;
    this->tipo = tipo;
